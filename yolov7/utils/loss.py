    ...
    def build_targets(self, p, targets, imgs):
        ...
        for batch_idx in range(p[0].shape[0]):
            ...
            for i, pi in enumerate(p):
                ...
                # to run on gpu, I followed this: https://stackoverflow.com/questions/74372636/indices-should-be-either-on-cpu-or-on-the-same-device-as-the-indexed-tensor
                # from_which_layer.append(torch.ones(size=(len(b),)) * i)
                from_which_layer.append(
                    (torch.ones(size=(len(b),)) * i).to('cuda'))
            ...
            # make this work with cuda, I followed this: https://stackoverflow.com/questions/74372636/indices-should-be-either-on-cpu-or-on-the-same-device-as-the-indexed-tensor
